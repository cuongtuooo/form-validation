...
function Validation (options) {
    ...
    function validate(inputElement, rule) {
        var errorElement = getParent(inputElement, options.formGroupSelector).querySelector(options.erromess)
        var errorMessage
...
Validation.isRequed = function (selector, message){
    return {
        selector: selector,
        test: function(value){
...
Validation.minlength = function (selector, min, message){
    return {
        selector: selector,
        test: function(value){
            return value >=min  ? undefined :  message ||`phải dài hơn ${min} kí tự`
        }
    }
}
